...
set CLASSPATH=%APP_HOME%\lib\Tron-1.0.0.jar


@rem Execute lwjgl3
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LWJGL3_OPTS%  -classpath "%CLASSPATH%" The_Users.Tron_Challenge_Of_The_Grid.lwjgl3.Lwjgl3Launcher %*
